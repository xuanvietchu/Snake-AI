...
class SnakeGameAI:
    ...
    def __init__(self, w=WINDOW_W, h=WINDOW_H):
        self.w = w
        self.h = h
        # init display
    ...
    def _update_ui(self):
        ...
        # Create grid lines (white boundaries)
        ...
        for i, pt in enumerate(self.snake):
            if i == 0:
                ...
                pygame.draw.rect(self.display, BLUE2, pygame.Rect(pt.x+4, pt.y+4, 32, 32))
            else:
